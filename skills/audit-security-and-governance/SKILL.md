...
description: Scans the physical codebase for security vulnerabilities and data-protection/GDPR governance exposures, anchoring every finding to OWASP/CWE/GDPR references with calibrated confidence. Runs standalone on raw code or enriches against the blueprint/FDS when present.
dependencies:
...
* **Surface scanned:** [modules / config / dependency manifests / data stores covered]
...
### 5. Contract Drift (Enriched Runs Only)
